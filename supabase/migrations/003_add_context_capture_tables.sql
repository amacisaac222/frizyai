-- Add Context Capture Tables to Existing Frizy Schema
-- This migration adds tables for capturing Claude Code sessions
-- Compatible with existing TEXT-based ID schema

-- 1. Sessions table - Represents Claude Code conversations
-- Using TEXT id to match existing schema pattern
...
-- 2. Context Blocks table - Work units within sessions
...
-- 3. Context Traces table - Operations within blocks
...
-- Success message
SELECT 'Context capture tables added successfully! 🎉' as message;